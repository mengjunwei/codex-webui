...
CREATE INDEX IF NOT EXISTS idx_tool_policies_scope_team_role_type_enabled ON tool_policies (scope, team_id, role, rule_type, enabled);
CREATE INDEX IF NOT EXISTS idx_tool_policies_priority_id ON tool_policies (priority DESC, id);
